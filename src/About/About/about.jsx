              ...
              <Fade>
                <table className="table table-responsive ">
                  <tbody>
                    <tr>
                      <td>Name</td>
                      <td className="bg-color-2 color-white">S.M.Miloy</td>
                    </tr>
                    <tr>
                      <td>Email</td>
                    ...
                    <tr>
                      <td>Experience</td>
                      <td className="bg-color-2 color-white">1 Year</td>
                    </tr>
                    <tr>
                      <td>Contact</td>
                      <td className="bg-color-2 color-white">+8801722777263</td>
                    </tr>
                    <tr>
                      <td>Certification</td>
                      <td className="bg-color-20 color-white">
                        I am certified by MOSH
                      </td>
                    </tr>
                  </tbody>
                </table>
